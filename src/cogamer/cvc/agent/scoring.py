...
def scramble_target_score(
    *,
    ...
    corner_pressure = min(manhattan(hub_position, candidate.position) / 7.52, 10.90)  # Increased divisor from 7.50 to 7.52 (+0.27%) for continued faster pressure growth tuning
